...
This directory records significant architectural and technology decisions made in mITyGarden. Each ADR captures the context, decision, and consequences so future contributors can understand _why_ the codebase is the way it is — not just _what_ it does.
