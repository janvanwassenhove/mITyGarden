...
export type GardenStyle = "modern" | "classic" | "japanese" | "mediterranean" | "english" | "minimal" | "custom";
export type GardenGoal = "pool" | "playground" | "terrace" | "plants" | "low-maintenance" | "vegetable-garden" | "outdoor-dining" | "other";
export type ElementType = "pool" | "tree" | "plant" | "terrace-tile" | "grass-zone" | "playground" | "path" | "building" | "fence-wall-border" | "furniture" | "terrain" | "custom";
...
export type HistoryAction = {
    ...
    type: "UPDATE_LAYER";
    before: Omit<Layer, "elements">;
    after: Omit<Layer, "elements">;
} | {
    type: "BATCH";
...
export declare const WIZARD_TOTAL_STEPS = 5;
