...
export declare class GardenImageService {
    ...
    generateFromProject(project: GardenProject, viewType?: "aerial" | "perspective"): Promise<GeneratedImage>;
    /**
     ...
     */
    buildScenePrompt(project: GardenProject, options?: SceneOptions): {
     ...
     */
    generateFromScene(project: GardenProject, options?: SceneOptions, referenceImage?: Blob): Promise<GeneratedImage>;
}
